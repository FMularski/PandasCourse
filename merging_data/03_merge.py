...
out = pd.merge(left=ten, right=plw, how='inner', left_index=True, right_index=True)

# %% merge with suffixes

out = pd.merge(left=ten, right=plw, how='inner', left_index=True, right_index=True, suffixes=("_TEN", "_PLW"))

# %% merge on index, outer

out = pd.merge(left=ten, right=plw, how='outer', left_index=True, right_index=True)

# %% merge with suffixes

out = pd.merge(left=ten, right=plw, how='outer', left_index=True, right_index=True, suffixes=("_TEN", "_PLW"))
